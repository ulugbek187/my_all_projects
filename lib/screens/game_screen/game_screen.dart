...
import 'package:my_all_projects/screens/widgets/image_items.dart';
import 'package:my_all_projects/utils/size_utils.dart';

import 'widgets/letter_items.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...List.generate(
                      state.allQuestions[state.questionIndex].images
                          .length,
                          (index) {
                        return ImageItems(
                          image: state
                              .allQuestions[state.questionIndex]
                              .images[index],
                        );
                      },
                    ),
                ...
                Align(
                  ...
                  child: Wrap(
                    ...
                    children: [
                      ...List.generate(
                        state.allQuestions[state.questionIndex]
                            .trueAnswer.length,
                            (index) {
                          return InkWell(
                            onTap: () {
